...
namespace Top
{
    public class ExcelDataTableTool : EditorWindow
    {
        ...
        public static readonly string DATA_ROW_END = Constant.DATA_ROW_END;
        private static readonly string DATA_TABLE_END = Constant.DATA_TABLE_END;
        ...
        private void GenerateCSharpClass(string tableName, List<FieldDefinition> fields)
        {
            ...
            sb.AppendLine($"    /// </summary>");
            sb.AppendLine($"    public class {tableName}{DATA_TABLE_END} : DataTableBase<{tableName}{DATA_ROW_END}>");
            sb.AppendLine("    {");
            sb.AppendLine($"        private static {tableName}{DATA_TABLE_END} _instance;");
            sb.AppendLine($"        public static {tableName}{DATA_TABLE_END} Instance");
            sb.AppendLine("        {");
            sb.AppendLine("            get");
            sb.AppendLine("            {");
            sb.AppendLine("                if (_instance == null)");
            sb.AppendLine($"                    _instance = new {tableName}{DATA_TABLE_END}();");
            ...
            string filePath = Path.Combine(classOutputFolder, $"{tableName}{DATA_ROW_END}.cs");
            ...
            Debug.Log($"[代码] 生成：{tableName}{DATA_ROW_END}.cs");
        }
        /// <summary>
        /// 获取C#类型名
        /// </summary>
